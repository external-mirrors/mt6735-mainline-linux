...
#define MT6735_MUTEX_MOD_DISP_OVL		6
#define MT6735_MUTEX_MOD_DISP_RDMA0		7
#define MT6735_MUTEX_MOD_DISP_RDMA1		8
#define MT6735_MUTEX_MOD_DISP_WDMA		9
#define MT6735_MUTEX_MOD_DISP_CCORR		10
#define MT6735_MUTEX_MOD_DISP_COLOR		11
#define MT6735_MUTEX_MOD_DISP_AAL		12
#define MT6735_MUTEX_MOD_DISP_GAMMA		13
#define MT6735_MUTEX_MOD_DISP_DITHER		14
#define MT6735_MUTEX_MOD_DISP_PWM		16
...
static const u8 mt6735_mutex_mod[DDP_COMPONENT_ID_MAX] = {
	[DDP_COMPONENT_OVL0] = MT6735_MUTEX_MOD_DISP_OVL,
	[DDP_COMPONENT_RDMA0] = MT6735_MUTEX_MOD_DISP_RDMA0,
	[DDP_COMPONENT_RDMA1] = MT6735_MUTEX_MOD_DISP_RDMA1,
	[DDP_COMPONENT_WDMA0] = MT6735_MUTEX_MOD_DISP_WDMA,
	[DDP_COMPONENT_CCORR] = MT6735_MUTEX_MOD_DISP_CCORR,
	[DDP_COMPONENT_COLOR0] = MT6735_MUTEX_MOD_DISP_COLOR,
	[DDP_COMPONENT_AAL0] = MT6735_MUTEX_MOD_DISP_AAL,
	[DDP_COMPONENT_GAMMA] = MT6735_MUTEX_MOD_DISP_GAMMA,
	[DDP_COMPONENT_DITHER0] = MT6735_MUTEX_MOD_DISP_DITHER,
	[DDP_COMPONENT_PWM0] = MT6735_MUTEX_MOD_DISP_PWM,
};
...
static const u16 mt6735_mutex_sof[DDP_MUTEX_SOF_MAX] = {
	[MUTEX_SOF_SINGLE_MODE] = MUTEX_SOF_SINGLE_MODE,
	[MUTEX_SOF_DSI0] = MUTEX_SOF_DSI0,
	[MUTEX_SOF_DSI1] = MUTEX_SOF_DSI1,
	[MUTEX_SOF_DPI0] = MUTEX_SOF_DPI0,
