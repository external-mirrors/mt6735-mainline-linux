...
#ifndef _DT_BINDINGS_CLK_MT6735_MMSYS_H
#define _DT_BINDINGS_CLK_MT6735_MMSYS_H
...
#define CLK_MM_AXI_ASIF			19
#define CLK_MM_DSI_ENGINE		20
#define CLK_MM_DSI_DIGITAL		21
#define CLK_MM_DPI_ENGINE		22
#define CLK_MM_DPI_PIXEL		23
